...
public class DBFField {
	...
	*/
	public String getName() {
		 ...
		 * 解决读取时乱码问题
		 */
		return new String( this.fieldName, 0, this.nameNullIndex, Utils.CHARSET_GBK);
	}
  ...
  // byte indexFieldFlag;              /* 31 */
	...
	*/
	public void setName(String name) {
		...
		// this.fieldName = value.getBytes(Charset.forName("GBK"));
		this.fieldName = name.getBytes(Utils.CHARSET_GBK);
